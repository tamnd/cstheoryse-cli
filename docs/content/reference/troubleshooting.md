...
Most of these come down to network reality or how cstheoryse serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cstheoryse rate-limits like any public site. cst2 already paces
...
Where a surface is gated, cst2 reads a cookie or token you supply
...
`cst2`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cst2 actually did
